...
const REFERRAL_BASE_URL = "https://t.me/Birrgram_bot/myapp";
...
async function ensureUser(tgUser, referralId) {
  ...
  const ref = String(referralId || "").trim();
  ...
  // Referral is credited only after the invited user has passed both channel checks.
